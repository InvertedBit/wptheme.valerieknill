            ...
            <header class="uk-comment-header">
                <div class="uk-grid-medium uk-flex-middle uk-grid" uk-grid="">
                    ...
                    <div class="uk-width-expand">
                        <h4 class="uk-comment-title uk-margin-remove comment-title"><a class="uk-link-reset" href="<?php echo $comment->comment_author_url; ?>"><?php echo $comment->comment_parent . ' > ' . $comment->comment_ID . ': ' . $comment->comment_author; ?></a></h4>
